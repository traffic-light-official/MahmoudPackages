...
- The version of `drf-file-pipeline` affected
...
- Pin `drf-file-pipeline` to a specific version range in production and review
...
- See `docs/security.md` for package-specific security guidance (secrets,
  header handling, and trust boundaries specific to `drf-file-pipeline`).
