...
- The version of `drf-ratelimit-plus` affected
...
- Pin `drf-ratelimit-plus` to a specific version range in production and review
...
- See `docs/security.md` for package-specific security guidance (secrets,
  header handling, and trust boundaries specific to `drf-ratelimit-plus`).
