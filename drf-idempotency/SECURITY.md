...
- The version of `drf-idempotency` affected
...
- Pin `drf-idempotency` to a specific version range in production and review
...
- See `docs/security.md` for package-specific security guidance (secrets,
  header handling, and trust boundaries specific to `drf-idempotency`).
