...
- The version of `drf-partial-response-fields` affected
...
- Pin `drf-partial-response-fields` to a specific version range in production and review
...
- See `docs/security.md` for package-specific security guidance (secrets,
  header handling, and trust boundaries specific to `drf-partial-response-fields`).
