...
- The version of `drf-api-reverse` affected
...
- Pin `drf-api-reverse` to a specific version range in production and review
...
- Never point `scaffold`/`check` at an OpenAPI contract you do not trust
  (see `docs/security.md`): generated code is written verbatim from
  schema field/operation names into Python source files.
- See `docs/security.md` for package-specific security guidance.
