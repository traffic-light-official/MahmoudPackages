# Contributing to drf-notification
...
This project follows the [Code of Conduct](https://github.com/MahmoudGShake/MahmoudPackages/blob/master/drf-notification/CODE_OF_CONDUCT.md). By
...
cd MahmoudPackages/drf-notification
python -m venv .venv
...
Any change to `src/drf_notification/models.py` requires a matching
migration generated with `python manage.py makemigrations
drf_notification` (using the test settings module,
