...
- The version of `drf-llm-gateway` affected
...
- Pin `drf-llm-gateway` to a specific version range in production and review
...
- See `docs/security.md` for package-specific security guidance (secrets,
  header handling, and trust boundaries specific to `drf-llm-gateway`).
