...
- The version of `drf-contract-test` affected
...
- Pin `drf-contract-test` to a specific version range in production and review
...
- See `docs/security.md` for package-specific security guidance (secrets,
  header handling, and trust boundaries specific to `drf-contract-test`).
