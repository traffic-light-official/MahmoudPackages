...
- The version of `drf-jwt-auth-kit` affected
...
- Pin `drf-jwt-auth-kit` to a specific version range in production and review
...
- See `docs/security.md` for package-specific security guidance (secrets,
  header handling, and trust boundaries specific to `drf-jwt-auth-kit`).
