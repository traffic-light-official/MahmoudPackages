...
```bash
git clone https://github.com/mahmoudgshaker/drf-n-plus-one-query-guard.git
cd drf-n-plus-one-query-guard
python -m venv .venv
...
Open a [GitHub Discussion](https://github.com/mahmoudgshaker/drf-n-plus-one-query-guard/discussions)
