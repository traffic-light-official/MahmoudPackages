...
- The version of `drf-changelog-generator` affected
...
- Pin `drf-changelog-generator` to a specific version range in production and review
...
- See `docs/security.md` for package-specific security guidance (secrets,
  header handling, and trust boundaries specific to `drf-changelog-generator`).
