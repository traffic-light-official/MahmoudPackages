...
- The version of `drf-error-response-standardizer` affected
...
- Pin `drf-error-response-standardizer` to a specific version range in production and review
...
- See `docs/security.md` for package-specific security guidance (secrets,
  header handling, and trust boundaries specific to `drf-error-response-standardizer`).
