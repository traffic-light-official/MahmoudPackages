# Contributing to drf-error-response-standardizer
...
```bash
git clone https://github.com/mahmoudgshaker/drf-error-response-standardizer.git
cd drf-error-response-standardizer
python -m venv .venv
...
Open a [GitHub Discussion](https://github.com/mahmoudgshaker/drf-error-response-standardizer/discussions)
