...
This project follows the [Code of Conduct](https://github.com/MahmoudGShake/MahmoudPackages/blob/master/drf-error-response-standardizer/CODE_OF_CONDUCT.md). By
...
cd MahmoudPackages/drf-error-response-standardizer
python -m venv .venv
