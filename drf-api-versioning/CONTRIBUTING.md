...
```bash
git clone https://github.com/mahmoudgshaker/drf-api-versioning.git
cd drf-api-versioning
python -m venv .venv
...
Open a [GitHub Discussion](https://github.com/mahmoudgshaker/drf-api-versioning/discussions)
