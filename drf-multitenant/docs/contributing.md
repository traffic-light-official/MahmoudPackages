# Contributing to drf-multitenant
...
This project follows the [Code of Conduct](https://github.com/mahmoudgshaker/drf-multitenant/blob/main/CODE_OF_CONDUCT.md). By
