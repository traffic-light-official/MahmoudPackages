...
- The version of `drf-multitenant` affected
...
- Pin `drf-multitenant` to a specific version range in production and review
...
- See `docs/security.md` for package-specific security guidance (secrets,
  header handling, and trust boundaries specific to `drf-multitenant`).
